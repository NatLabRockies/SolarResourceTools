...
curveLeft = np.array([
    ...
    [-60.0, -60.0, 5.6, 7.5, 9.0, 10.4, 11.6, 12.7, 13.8, 14.7,
     ...
     [-60.0,-60.0,-6.0,-4.4, -2.7, -1.1,  0.4,  2.0,  3.4,  4.9, 
        6.3,   7.7,  9.0, 10.3, 11.6, 12.8, 14.0, 15.2, 16.3, 17.5, 
        18.6, 19.6, 20.7, 21.7, 22.6, 23.6, 24.5, 25.5, 26.4, 27.2, 
        28.1, 28.9, 29.7, 30.5, 31.3, 32.1, 32.8, 33.6, 34.3, 35.0, 
        35.7, 36.4, 37.1, 37.7, 38.4, 39.0, 39.7, 40.3, 40.9, 41.6, 
        42.2, 42.8, 43.4, 44.1, 44.7, 45.3, 45.9, 46.5, 47.1, 47.8, 
        48.4, 49.0, 49.7, 50.3, 51.0, 51.6, 52.3, 53.0, 53.7, 54.4, 
        55.1, 55.8, 56.6, 57.4, 58.1, 58.9, 59.7, 60.6, 61.4, 62.3, 
        63.2, 64.1, 65.0, 65.9, 66.9, 67.9, 69.0, 70.0, 71.1, 72.2, 
        73.3, 74.5, 75.7, 76.9, 78.2, 79.5, 80.8, 82.2, 83.6, 85.0]])
...
curveRight = np.array([
    ...
    [32.2, 33.7, 34.8, 35.6, 36.3, 36.9, 37.4, 37.9, 38.3, 38.7,
     ...
     [13.1, 14.5, 15.8, 17.1, 18.3, 19.6, 20.8, 21.9, 23.0, 24.1, 
    25.2, 26.2, 27.3, 28.2, 29.2, 30.1, 31.1, 32.0, 32.8, 33.7, 
    34.5, 35.3, 36.1, 36.9, 37.6, 38.4, 39.1, 39.8, 40.5, 41.2, 
    41.9, 42.5, 43.2, 43.8, 44.4, 45.1, 45.7, 46.3, 46.9, 47.5, 
    48.1, 48.7, 49.3, 49.9, 50.5, 51.0, 51.6, 52.2, 52.8, 53.4, 
    54.0, 54.6, 55.2, 55.9, 56.5, 57.1, 57.8, 58.4, 59.1, 59.8, 
    60.5, 61.2, 61.9, 62.6, 63.4, 64.1, 64.9, 65.7, 66.5, 67.4, 
    68.2, 69.1, 70.0, 71.0, 71.9, 72.9, 73.9, 74.9, 76.0, 77.1, 
    78.2, 79.3, 80.5, 81.7, 83.0, 84.2, 85.5, 86.9, 88.2, 89.7, 
    91.1, 92.6, 94.1, 95.7, 97.3, 98.9,100.6,102.4,104.1,106.0]
])
